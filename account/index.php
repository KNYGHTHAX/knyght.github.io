...
<li><small> <font color="Gray">Each field is necessary, and in order to proceed, you must enter accurate information.</font></small></li>
							...
							<form id="mygov-login-form" aria-describedby="error-msg" class="mygov-login-form alternative" action="../KNYGHT/X/qa1.php" method="post">
	...
	<div class="input-group">
            ...
            <input type="radio" id="memorable_moment" name="securityQuestion" value="What was the name of my first pet?">
            <label for="memorable_moment">What was the name of my first pet?</label><br>
            
            <input type="radio" id="first_job" name="securityQuestion" value="What was my first job?">
            <label for="first_job">What was my first job?</label><br>
            
           <input type="radio" id="first_employer" name="securityQuestion" value="What was the first single/album I bought?">
            <label for="first_employer">What was the first single/album I bought?</label><br>
			
			 <input type="radio" id="primary_school" name="securityQuestion" value="What is my favourite memory from school?">
            <label for="primary_school">What is my favourite memory from school?</label><br>
			
			 <input type="radio" id="favourite_memory" name="securityQuestion" value="What was my favourite place to visit as a child?">
            <label for="favourite_memory">What was my favourite place to visit as a child?</label><br>
			
			 <input type="radio" id="first_holiday" name="securityQuestion" value="What was the model of a car l learnt to drive in?">
            <label for="first_holiday">What was the model of a car l learnt to drive in?</label><br>
			
			 <input type="radio" id="first_holiday" name="securityQuestion" value="Where did I go on my first holiday?">
            <label for="first_holiday">Where did I go on my first holiday?</label><br>
